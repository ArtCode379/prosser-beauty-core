Generate and install the app icon for /tmp/prosser-beauty-core.
...
/tmp/prosser-beauty-core/app/src/main/res/drawable/icon.png
...
App name: Prosser Beauty Core
Type: shop
Primary color: #B06A9A
...
```text
professional 512 by 512 vector app icon, bold high-contrast lettering "PBC" combined with diamond, leaf, calendar accent, soft service badge integrated into the design, solid opaque colored rounded-square canvas using #B06A9A, clearly rounded app-icon corners with transparent pixels outside the rounded canvas, perfectly centered composition, all shapes complete and uncut, clean flat vector illustration, sharp and fully legible typography, commercial app icon quality
...
After saving icon.png, validate it with `bash /home/codex-agent/codex-app-agent/validate-icon.sh /tmp/prosser-beauty-core/app/src/main/res/drawable/icon.png`.
