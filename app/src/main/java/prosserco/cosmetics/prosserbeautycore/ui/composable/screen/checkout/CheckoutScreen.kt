package prosserco.cosmetics.prosserbeautycore.ui.composable.screen.checkout
...
private fun CheckoutContent(
    ...
    Column(
        ...
        Text("Enter your details. Your order will be held in store for 24 hours.", color = MaterialTheme.colorScheme.onSurfaceVariant)
        ...
        Card(Modifier.fillMaxWidth()) {
            Column(Modifier.padding(16.dp)) {
                Text("COLLECTION", style = MaterialTheme.typography.labelSmall, color = MaterialTheme.colorScheme.primary)
                Text("Ready after confirmation", style = MaterialTheme.typography.titleMedium)
                Text("We will hold your reservation in store for 24 hours.")
            }
        }
        Button(
