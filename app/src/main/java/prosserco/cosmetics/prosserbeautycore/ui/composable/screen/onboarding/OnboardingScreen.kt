...
private val onboardingPagesContent = listOf<OnboardingContent>(
    OnboardingContent(
        titleRes = R.string.tsdik_page_1_title,
        descriptionRes = R.string.tsdik_page_1_description,
        imageRes = R.drawable.tsdik_ic_launcher_background,
    ),
    OnboardingContent(
        titleRes = R.string.tsdik_page_2_title,
        descriptionRes = R.string.tsdik_page_2_description,
        imageRes = R.drawable.tsdik_ic_launcher_background,
    ),
    OnboardingContent(
        titleRes = R.string.tsdik_page_2_title,
        descriptionRes = R.string.tsdik_page_3_description,
        imageRes = R.drawable.tsdik_ic_launcher_background,
    ),
)
